...
import OfertasEpisReport from "../../sources/views/ofertasEpisReport";


var editButton = "<span class='onEdit webix_icon wxi-pencil'></span>";
var deleteButton = " <span class='onDelete webix_icon wxi-trash'></span>";
var propuestaButton = " <span class='onPropuesta fa-solid fa-coins'></span>";
...
export const ofertasSubcontrataGrid = {
    ...
    getGrid: (app) => {
        ...
        actionsTemplate += deleteButton + propuestaButton + PrintButton;
        var datatableOfertasSubcontrata = {
            ...
            ready: function () {
                this.attachEvent("onItemDblClick", function (id, e, node) {
                    ...
                    var ofertaCosteId = curRow.ofertaCosteId;
                    ofertasSubcontrataGrid.edit(ofertaId, ofertaCosteId)
                });
            },
            columns: [
                ...
                { id: "importeCliente", header: [translate("Total"), { content: "textFilter" }], css: { "text-align": "right" }, sort: "string", width: 100, format: webix.i18n.numberFormat },
            ...
            onClick: {
                ...
                "onPrint": function (event, id, node) {
                    ...
                    var rep = curRow.infOfertas;
                    rep = rep + "_nopresentacion";
                    var valorado = curRow.valorado;
                    ...
                    setTimeout(() => {
                        win.showWindow(curRow.ofertaId, null, file, valorado);
                    }, 50);
                }
            },
            editable: true,
    ...
    loadGrid: (expedienteid, ofertaId, importeobra, selectofertaid) => {
        ...
        if (expedienteid) {
            ...
            ofertasService.getOfertasExpediente(expedienteId, 2, null)
                .then(rows => {
                    if (rows.length > 0) {
    ...
    edit(ofertaId, ofertaCosteId) {

        const activeTab = $$("tabViewExpediente").getValue();  // Obtener el id de la pestaña activa
        localStorage.setItem("activeTab", activeTab);

        _app.show('/top/ofertasSubcontrataForm?ofertaId=' + ofertaId + '&expedienteId=' + expedienteId + '&importeObra=' + importeObra + '&ofertaCosteId=' + ofertaCosteId);
    },
