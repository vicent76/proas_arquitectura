...
export const ofertasService = {
    ...
    getOfertasExpediente: (expedienteId, esCoste, esAdicional) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + `/api/ofertas/expedientes/tecnicas/${expedienteId}/${esCoste}/${esAdicional}`
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
    ...
    getOfertasAceptadasExpediente: (expedienteId, esCoste) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + `/api/ofertas/expedientes/tecnicas/aceptadas/nuevo/${expedienteId}/${esCoste}`
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
    ...
    getLineasOferta: (ofertaId) => {
        ...
        getLineasOfertaCoste: (ofertacosteId, ofertaSubcontrataId, expedienteId) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/lineas/coste/vinculadas/no-vinculadas/" + ofertacosteId  + "/" + ofertaSubcontrataId + "/" + expedienteId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
    ...
    putOferta: (oferta) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/" + oferta.ofertaId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
    ...
    putLineaOferta: (ofertaLinea, ofertaLineaId) => {
        ...
        putLineaOfertaSubcontrata: (ofertaLinea, ofertaLineaId) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/lineas/subcontrata/desde/propuesta/lineas/" + ofertaLineaId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
     ...
     putLineaOfertaAsociadas: (ofertaLinea, ofertaLineaId) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/lineas/actuliza/ofertas/asociadas/coste/" + ofertaLineaId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
     ...
     updateLineasSubcontrata: (ids, ofertaSubcontrataId) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/generar/nuevas-lineas/subcontrata/desde/coste/lineas/" + ofertaSubcontrataId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
    ...
    postOfertaContrato: (data, ofertaId, contratoId, expedienteId) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/ofertas/generar-contrato/desde/oferta/tecnica/" + ofertaId + "/" + 1 + "/" + contratoId + "/" + expedienteId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
        ...
        putContratoAsociado: (data) => {
        return new webix.promise((success, fail) => {
            devConfig.getConfig()
                .then(conf => {
                    var url = conf.urlApi + "/api/contratos/" + data.contratoId;
                    return webix.ajax()
                        .timeout(10000)
                        .headers({
                            "Content-Type": "application/json"
                        })
                        .put(url, {contrato: data});
                })
                .then(function (result) {
                    success(result.json());
                })
