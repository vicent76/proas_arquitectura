...
export default class Propuestas extends JetView {
        ...
        var datatablePropuestas = {
            ...
            columns: [
                ...
                },
                {
                    id: "ofertaGanadora",
                     header: [
                        { text: translate("Ganadora"), css: "text-align-right" },
                        { content: "textFilter" }
                    ],
                    width: 100,
                    options: [
                    ...
                    template: function (obj) {
                        return obj.ofertaGanadora == 1 ? "SI" : "NO";
                    }
                },
    ...
    urlChange(view, url) {
        ...
        this.load(selectPropuestaId)
    }

    load(selectPropuestaid) {
        selectPropuestaId = selectPropuestaid;
        propuestasService.getPropuestasSubcontrata(subcontrataId, 0, 0)
            .then((data) => {
                if (!data) {
                    data = []
                }
