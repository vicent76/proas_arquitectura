	...
	config() {
		...
		var mainToolBar = {
			...
			elements: [
				...
				{
					view: "button", type: "icon", icon: "mdi mdi-note-multiple-outline", width: 50, align: "right",
					tooltip: "Ir a los expedientes",
					click: () => {
						webix.storage.local.remove("tabViewExpedienteActive");
						this.show('/top/expedientes');
					}
				},
				{
